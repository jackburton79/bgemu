...
Animation::_ApplyColorMODs(::Bitmap *bitmap, CREColors *patchColors)
{
	...
	// 16-27
	ApplyRange(palette, 0x10, patchColors->minor);

	// 28-39
	ApplyRange(palette, 0x1c, patchColors->major);

	// 40-51
	ApplyRange(palette, 0x28, patchColors->skin);

	// 52-63
	ApplyRange(palette, 0x34, patchColors->leather);

	// 64-75
	ApplyRange(palette, 0x40, patchColors->armor);

	// 76-87
	ApplyRange(palette, 0x4c, patchColors->hair);

	// 88-95
	// TODO: only 8 here
	//ApplyRange(palette, 0x58, patchColors->minor);
